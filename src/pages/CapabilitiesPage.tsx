...
import { ArrowUpRight, Sparkles, Layers, Box, Cpu } from 'lucide-react';
    ...
    <div className="w-full pt-28 pb-16 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 relative z-10">
        <div className="max-w-3xl space-y-4">
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-indigo-500/10 border border-indigo-500/30 text-indigo-300 text-xs font-semibold shadow-[0_0_15px_rgba(99,102,241,0.2)]">
          ...
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold font-display text-white tracking-tight leading-tight">
            What We <span className="text-transparent bg-clip-text bg-gradient-to-r from-indigo-400 via-purple-300 to-pink-400">Build</span>
          </h1>
      ...
      {/* Main What We Build Section (with 3D matrix and detailed cards) */}
      <WhatWeBuildSection />
      ...
      {/* Product Lab & Experimental Systems */}
      <ProductLabSection />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 relative z-10">
        <div className="p-8 sm:p-12 rounded-3xl bg-gradient-to-r from-[#120f2e] via-[#0d0a21] to-[#070514] border border-indigo-500/30 shadow-[0_20px_50px_rgba(0,0,0,0.6)] flex flex-col md:flex-row items-center justify-between gap-8">
          <div className="space-y-2 max-w-2xl">
            <div className="inline-flex items-center gap-2 px-2.5 py-0.5 rounded-full bg-indigo-500/20 text-indigo-300 text-xs font-mono">
          ...
          <Link to="/contact" className="shrink-0">
            <Button
              variant="primary"
              size="lg"
              className="!bg-indigo-600 hover:!bg-indigo-500 !text-white border-none shadow-[0_0_20px_rgba(99,102,241,0.3)]"

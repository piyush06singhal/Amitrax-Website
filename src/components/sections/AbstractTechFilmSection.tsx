...
export const AbstractTechFilmSection: React.FC = () => {
  ...
  return (
    <section className="relative w-full py-24 lg:py-32 bg-[#04060d] border-y border-white/10 overflow-hidden">
      ...
      <div className="absolute inset-0 z-1 bg-gradient-to-t from-[#04060d] via-transparent to-[#04060d] pointer-events-none" />
      <div className="absolute inset-0 z-1 bg-gradient-to-r from-[#04060d] via-transparent to-[#04060d] pointer-events-none" />

      {/* Foreground Content */}
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
        <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-8">
          <div className="max-w-3xl space-y-5">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-md bg-white/[0.05] border border-white/10 font-mono text-xs text-slate-300 backdrop-blur-md">
              <Activity className="w-3.5 h-3.5 text-cyan-400 animate-pulse" />
              <span className="text-cyan-400 font-semibold">02 // ABSTRACT FILM</span>
          ...
          <div className="flex items-center gap-3 p-1.5 rounded-2xl bg-black/60 border border-white/10 backdrop-blur-md shrink-0">
            <span className="text-xs font-mono text-slate-400 px-2">STREAM VELOCITY:</span>
            <button
              type="button"
            ...
            <button
              ...
              className={`px-3 py-1.5 rounded-xl text-xs font-mono transition-all ${
                pulseSpeed === 'accelerated'
                  ? 'bg-purple-500/20 text-purple-300 border border-purple-500/40 font-semibold shadow-[0_0_10px_rgba(168,85,247,0.2)]'
                  : 'text-slate-400 hover:text-white'
              }`}
            >
              Accelerated Pulse
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 pt-6 border-t border-white/10">
          <div className="p-4 rounded-xl bg-black/50 border border-white/5 backdrop-blur-md space-y-1">
            ...
            <p className="text-xs text-slate-400">Deterministic inter-process routing</p>
          </div>
          ...
          <div className="p-4 rounded-xl bg-black/50 border border-white/5 backdrop-blur-md space-y-1">
            ...
            <p className="text-xs text-slate-400">Zero-drift synchronization</p>
          </div>
          ...
          <div className="p-4 rounded-xl bg-black/50 border border-white/5 backdrop-blur-md space-y-1">
            ...
            <p className="text-xs text-slate-400">Self-healing multi-region mesh</p>
          </div>
          ...
          <div className="p-4 rounded-xl bg-black/50 border border-white/5 backdrop-blur-md space-y-1">
            ...
            <p className="text-xs text-slate-400">Lean memory & stripped dependencies</p>
          </div>
        </div>
      </div>
    </section>

...
export const CompanyValuesSection: React.FC = () => {
  ...
  return (
    <section id="values" className="relative w-full py-20 lg:py-28 bg-[#05070e] border-t border-white/5">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 space-y-16">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
              ...
              return (
                <div
                  ...
                  className={`p-5 rounded-2xl transition-all duration-300 border cursor-pointer flex flex-col justify-between ${
                    isSelected
                      ? 'bg-gradient-to-br from-[#0c1633] to-[#070d1e] border-cyan-400/80 shadow-lg shadow-cyan-500/10 ring-1 ring-cyan-400/40'
                      : 'bg-[#080d1e]/80 border-white/10 hover:border-white/20 hover:bg-[#0b1228]'
                  }`}
                >
                  ...
                  <div className="pt-4 mt-3 border-t border-white/5 flex items-center justify-between text-[11px]">
                    <span className="text-slate-400">Systemic Standard</span>
                    <span className="text-cyan-400 font-medium">Active Rule</span>
                  </div>
                </div>
              );
            })}
          ...
          <div className="lg:col-span-5 p-7 sm:p-8 rounded-3xl bg-gradient-to-br from-[#0a1024] to-[#050814] border border-cyan-500/30 shadow-2xl backdrop-blur-xl space-y-6 sticky top-28">
            ...
            <div className="relative h-44 rounded-2xl bg-black/40 border border-white/10 flex items-center justify-center overflow-hidden">
              <div
                className="absolute inset-0 opacity-20 blur-xl"
                style={{ backgroundColor: activeValue.accentColor }}
              />
              <div className="relative z-10 text-center space-y-2 p-4">
                <div className="w-14 h-14 rounded-2xl bg-white/[0.05] border border-white/20 mx-auto flex items-center justify-center shadow-lg">

...
export const HowWeBuildSection: React.FC = () => {
  ...
  return (
    <section id="methodology" className="relative w-full py-20 lg:py-28 bg-white dark:bg-[#04060d] border-t border-slate-200 dark:border-white/5">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 space-y-16">
              ...
              return (
                <button
                  ...
                  className={`p-4 rounded-xl text-left transition-all border cursor-pointer ${
                    isSelected
                      ? 'bg-gradient-to-b from-cyan-100 to-blue-100 dark:from-cyan-500/20 dark:to-blue-600/20 border-cyan-500 dark:border-cyan-400 text-slate-900 dark:text-white shadow-lg'
                      : 'bg-white dark:bg-[#080d1e]/80 border-slate-200 dark:border-white/10 text-slate-500 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white hover:bg-slate-100 dark:hover:bg-white/5'
                  }`}
                >
                  <div className="flex items-center justify-between mb-2">
                    <span className="text-xs font-mono font-bold text-cyan-700 dark:text-cyan-400">{stage.step}</span>
                    {getStageIcon(stage.step)}
                  </div>
                  <div className="font-bold text-sm text-slate-900 dark:text-white font-display">{stage.title}</div>
                  <div className="text-[11px] text-slate-500 dark:text-slate-400 truncate">{stage.subtitle}</div>
                </button>
              );
            })}
          </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
              <div className="lg:col-span-7 space-y-4">
                <div className="flex items-center gap-2">
                  <span className="text-xs font-semibold px-2.5 py-0.5 rounded-full bg-cyan-100 dark:bg-cyan-500/20 text-cyan-700 dark:text-cyan-300 border border-cyan-500/40">
                ...
                <div className="space-y-2 pt-2">
                  <h4 className="text-xs font-semibold text-slate-500 dark:text-slate-300 uppercase tracking-wider">
                    Core Methodology
                  </h4>
              ...
              <div className="lg:col-span-5 space-y-4 lg:border-l lg:border-slate-200 dark:lg:border-white/10 lg:pl-8">
                {/* Evolving Lifecycle Visual Scene (Section 20) */}
                <LifecycleStageVisual stageIndex={selectedStageIdx} />

                <div className="p-4 rounded-xl bg-slate-50 dark:bg-white/[0.03] border border-slate-200 dark:border-white/10 space-y-1.5">
        ...
        <div className="p-8 sm:p-10 rounded-3xl bg-gradient-to-r from-slate-100 via-white to-white dark:from-[#0c1530] dark:via-[#091024] dark:to-[#070c1b] border border-slate-200 dark:border-cyan-500/30 shadow-xl dark:shadow-2xl space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="p-6 rounded-2xl bg-slate-50 dark:bg-[#070b1a]/90 border border-slate-200 dark:border-white/10 space-y-4">
              <div className="flex items-center gap-3">
                <div className="p-2.5 rounded-xl bg-cyan-100 dark:bg-cyan-500/10 border border-cyan-500/30">
                ...
                <div>
                  ...
                  <p className="text-xs text-cyan-700 dark:text-cyan-400/90">
              ...
              <div className="grid grid-cols-2 gap-2.5 pt-2">
                {CONVERGENCE_SYSTEMS.engineering.attributes.map((attr, idx) => (
                  <div key={idx} className="p-3 rounded-lg bg-white dark:bg-white/[0.03] border border-slate-200 dark:border-white/5 space-y-1">
                    <div className="text-xs font-bold text-slate-900 dark:text-white">{attr.name}</div>
                    <div className="text-[11px] text-slate-500 dark:text-slate-400 leading-tight">{attr.desc}</div>
                  </div>
                ))}
              </div>
            </div>
            ...
            <div className="p-6 rounded-2xl bg-slate-50 dark:bg-[#070b1a]/90 border border-slate-200 dark:border-white/10 space-y-4">
              <div className="flex items-center gap-3">
                <div className="p-2.5 rounded-xl bg-purple-100 dark:bg-purple-500/10 border border-purple-500/30">
                ...
                <div>
                  ...
                  <p className="text-xs text-purple-700 dark:text-purple-400/90">

...
export const ServicesSection: React.FC = () => {
    ...
    switch (id) {
      ...
      case 'ai-intelligent-systems':
        return {
          ...
          tag: 'text-purple-300 bg-purple-500/10 border-purple-500/20',
        };
      case 'automation-solutions':
        return {
          accent: '#34d399',
  ...
  return (
    <section id="services" className="relative w-full py-20 lg:py-28 bg-[#05070e] border-t border-white/5">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <SectionHeader
          ...
          sublabel="Genuine Capabilities"
          title="Practical Engineering for"
          titleHighlight="Real Systems"
          description="We do not offer generic pricing packages or artificial tiers. We provide deep technical execution across the entire software development lifecycle, engineered to solve concrete operational constraints."
          badgeVariant="amber"
          actionSlot={
            <div className="flex flex-wrap items-center gap-1.5 p-1.5 rounded-xl bg-[#0a0f24] border border-white/10 shadow-lg">
              {categories.map((cat) => (
                <button
                  key={cat}
                  type="button"
            ...
            return (
              <div
                ...
                className={`rounded-2xl transition-all duration-300 border backdrop-blur-md overflow-hidden ${
                  isExpanded
                    ? `bg-gradient-to-br from-[#0c142c] via-[#090e20] to-[#060a17] ${colors.border} shadow-2xl`
                    : 'bg-[#090d1c]/80 border-white/10 hover:border-white/20 hover:bg-[#0c1226]'
                }`}
              >
                {/* Header Row */}
                <button
                ...
                {/* Expanded Details */}
                {isExpanded && (
                  <div className="px-6 pb-7 pt-2 border-t border-white/10 grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
                    ...
                    <div className="lg:col-span-5 space-y-4">
                      ...
                      <div className="p-4 rounded-xl bg-[#060914]/80 border border-white/10 space-y-2">
                    ...
                    <div className="lg:col-span-3 space-y-2">
                      ...
                      <span className="text-[11px] font-mono text-slate-400 text-center block">
        ...
        <div className="p-8 sm:p-12 rounded-3xl bg-gradient-to-r from-[#181105] via-[#120d04] to-[#0c0903] border border-amber-500/30 shadow-[0_20px_50px_rgba(0,0,0,0.6)] relative overflow-hidden">
          ...
          <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-8">
            <div className="space-y-3 text-center md:text-left max-w-2xl">
              ...
              <h3 className="text-2xl sm:text-3xl lg:text-4xl font-bold font-display text-white tracking-tight">
